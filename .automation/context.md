...
## What This Is
A HUD overlay mod displaying configurable information on screen. Intentionally simple -- older versions (1.15.x and below) were feature-heavy and overly complex; the mod was rebuilt from scratch at 1.18.2 to be minimal and focused.

Overlay options: Time, Light Level, Foot Level, Biome, Season, and location/spawn/death indicators.

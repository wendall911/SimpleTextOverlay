...
public class FontHelper {
    ...
    public static void draw(Minecraft mc, PoseStack matrix, TranslatableComponent label, int x, int y, int color, TextType textType) {
    ...
    private static void drawBackdrop(Minecraft mc, PoseStack matrix, int textWidth, int x, int y, int color, TextType textType) {
        ...
        if (textWidth != 0 && !mc.options.backgroundForChatOnly) {
